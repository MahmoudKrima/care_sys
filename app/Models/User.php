...
class User extends Authenticatable implements HasMedia
{
    ...
    {
        return $this->hasMany(DoctorMedia::class,'doctor_id','id');
    }
    ...
    {
        return $this->hasMany(Cart::class,'patient_id','id');
    }

    public function specialization()
    {
        return $this->belongsToMany(Specialization::class,'doctor_specialization','specialization_id','doctor_id');
    }

    public function appointment()
    {
        return $this->hasOne(DoctorAppointment::class,'doctor_id','id');
    }
